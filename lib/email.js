...
// Default sender. For real sending, set FROM_EMAIL to an address on a
// Resend-verified domain (e.g. noreply@darulhaya.com). Before your domain is
// verified, Resend's shared tester address (onboarding@resend.dev) can be used.
const DEFAULT_FROM = process.env.FROM_EMAIL || 'onboarding@resend.dev'
const APP_URL = process.env.NEXT_PUBLIC_APP_URL || 'http://localhost:3000'

/**
 * Low-level send. Returns Resend's { data, error } shape (does not throw on
 * API errors — check `error`).
 */
