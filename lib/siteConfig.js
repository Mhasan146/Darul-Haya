...
// Pre-filled message for the "Book a free assessment" call-to-action.
export const WHATSAPP_ASSESSMENT_MESSAGE = encodeURIComponent(
  "Assalamu alaikum, I'd like to book a free assessment for my child (Grades 3–8)."
)
export const WHATSAPP_ASSESSMENT_URL = `https://wa.me/${WHATSAPP_NUMBER}?text=${WHATSAPP_ASSESSMENT_MESSAGE}`
