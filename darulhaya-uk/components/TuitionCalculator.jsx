...
// Pricing: flat £300/month per child, 15% sibling discount on each
// additional child. Same price for every year group (Years 4–9).
// TODO(UK pricing): confirm real GBP figures — carried over from the .com site.
const BASE = 300
...
export default function TuitionCalculator() {
  ...
  return (
    <div className="max-w-md mx-auto mt-8 rounded-3xl bg-white border border-beige-dark shadow-md p-7 sm:p-8">
      ...
      <p className="text-clay/70 text-sm mb-5">Same price for every year group (Years 4–9). Add siblings to see the discount applied live.</p>
      ...
      <div className="mt-6 rounded-2xl bg-beige-dark/50 p-5 text-center" aria-live="polite">
        ...
        {saved > 0 ? (
          ...
          <p className="text-sm text-clay/60 mt-1">One child · Years 4–9</p>
        )}
      </div>
