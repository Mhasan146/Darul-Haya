...
export const metadata = { title: 'Application Successfully Received' }
  ...
  return (
    <div className="min-h-screen bg-beige flex items-center justify-center px-6 py-24">
      <div className="max-w-lg text-center">
        ...
        <p className="text-teal-dark text-sm font-semibold uppercase tracking-widest mb-3">Application received</p>
        ...
        <p className="mt-2 text-clay/80 leading-relaxed">
        ...
        <div className="mt-8 flex items-center justify-center gap-4 flex-wrap">
          ...
          <Link href="/contact" className="text-clay font-medium hover:text-teal-dark transition-colors">
            Contact us →
          </Link>
        </div>
      </div>
