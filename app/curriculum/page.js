...
export const metadata = {
  ...
  description:
    'What students learn at our online school: Ontario-aligned Language Arts, Math, Science, and Social Studies for Grades 2–9, with Arabic in every weekly timetable.',
...
export default function CurriculumPage() {
  return (
    <PagePlaceholder
      ...
      title="Curriculum"
      intro="Our curriculum pairs strong, provincially-aligned academics with character and values education, delivered in a structured sequence from Grade 2 through Grade 9."
      sections={[
        {
          id: 'grades',
          heading: 'Grade Levels (2–9)',
          body: 'Elementary (Grades 2–5) focuses on building strong foundations — fluent reading and writing, number sense and core math, and curiosity about the world through science and social studies — all at a pace that lets younger students feel secure and supported. At this stage boys and girls learn together.\n\nMiddle School (Grades 6–9) builds on those foundations with more advanced material, greater independence, and stronger study skills, preparing students for the demands of high school while keeping them in a focused, supervised environment. From Grade 6, boys and girls are taught in separate classrooms.',
        },
        {
          id: 'islamic',
          heading: 'Curriculum',
        ...
        },
        {
          ...
          body: 'Arabic language classes are part of every student\'s weekly schedule from Grade 2 through Grade 9. Classes are taught live by a dedicated teacher and progress through reading, writing, and conversational Arabic in a structured, grade-appropriate sequence.',
        },
      ]}
