...
export default function AboutPage() {
  return (
    <PagePlaceholder
      ...
      intro="Darul Haya is an online school for boys and girls in Grades 2 through 12, built around live, teacher-led classes and a complete, carefully chosen curriculum. It was founded by a teacher with more than fifteen years in the classroom — and a conviction that every child deserves small classes, real attention, and truly focused learning."
      sections={[
        {
          heading: 'Our Story',
