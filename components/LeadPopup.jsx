...
export default function LeadPopup() {
  ...
  function close() {
    ...
    requestAnimationFrame(() => {
      (prevFocus.current || document.body).focus()
    })
  }
      ...
      >
        ...
        {submitted ? (
          <div className="text-center py-6">
            ...
            <p className="text-clay/80 text-sm mt-1">Our team will reach out shortly.</p>
          </div>
        ) : (
          <>
            <h2 id="lead-popup-title" className="text-xl font-bold text-clay mb-1 pr-6">Have questions about Fall 2026 registration?</h2>
            <p className="text-clay/80 text-sm mb-5">
              Get instant answers regarding tuition, schedules, or curriculum directly from our team on WhatsApp.
            </p>
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-clay/80 text-xs">or request a call back</span>
              <div className="flex-1 h-px bg-clay/10" />
            </div>
            ...
            <form onSubmit={handleSubmit} noValidate data-netlify="true" data-netlify-recaptcha="true" name="darul-haya-lead">
              ...
              <div className="flex flex-col gap-3">
                <div>
                  <label htmlFor="lead-name" className="block text-xs font-semibold text-clay/80 mb-1">Name *</label>
                  <input
                    id="lead-name"
                    type="text"
                    required
                ...
                <div>
                  <label htmlFor="lead-email" className="block text-xs font-semibold text-clay/80 mb-1">Email *</label>
                  <input
                    id="lead-email"
                    type="email"
                    required
                ...
                <div>
                  <label htmlFor="lead-phone" className="block text-xs font-semibold text-clay/80 mb-1">Phone / WhatsApp <span className="font-normal">(optional)</span></label>
                  <input
                    id="lead-phone"
                    type="tel"
                    value={form.phone}
              ...
              <p className="text-center text-[10px] text-clay/80 mt-3">
                We strictly use your details for admissions inquiries only.
              </p>
            </form>
          </>
        )}
